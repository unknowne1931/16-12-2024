...
app.use(cors({
    origin: [ "https://www.stawro.com", "https://stawro.com", "http://localhost:3000", "http://192.168.16.250:3000" ],
                                        ...
                                        <div class="email-cnt-02">
                                            ...
                                            Your account has been successfully created at staWro.
                                             ...
                                             on the "Login" text.</p><br/>
                                                <a href = "https://www.stawro.com" style="text-decoration: none;">Login</a>
                                            <strong></strong><br/>
...
app.delete('/delete/users/admin/qno/from/admin/users/:id', async (req, res)=>{
    const id = req.params.id;
    try{
        const find_data = await Users_Questionsmodule.findByIdAndDelete({_id : id})
        return res.status(200).json({Status : "OK"})
    }catch (error) {
        console.log(error)
        return res.status(500).json({ success: false, message: error.message });
